...
| 04 - RCTX minimal package fixture | TODO | next pulse |
...
Pulse 04 should create the first minimal RCTX package fixture and decide whether
`rctx-io` is needed now or should stay deferred until an independent package
directory loader exists.
