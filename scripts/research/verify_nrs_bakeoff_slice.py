#!/usr/bin/env python3
"""Verify and regenerate a governed NRS bakeoff evidence slice."""
...
ANALYSIS_VERSION = "nrs-v0.3-bakeoff-slice-analysis-v1"
...
def main() -> None:
    ...
    if manifest.get("status") != "pass":
        fail("package status is not pass")
    ...
    analyzer = root / "scripts/research/analyze_nrs_bakeoff_slice.py"
    ...
    print("NRS v0.3 bakeoff slice verification: PASS")
