...
def main() -> None:
    ...
    # Keep the repository-facing path lexical. Resolving here follows Windows
    # junctions and can leak a machine-specific data-vault path into every
    # State package generated by this national driver.
    run_national(
        Path(os.path.abspath(args.nrs_root)), Path(os.path.abspath(args.output_dir))
    )
