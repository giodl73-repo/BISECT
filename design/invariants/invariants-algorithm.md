...
**Test:** `BISECT/crates/bisect-cli/src/bisection_runner.rs::test_run_all_splits_two_districts` (checks d1.is_disjoint(&d2) and d1.len()+d2.len()==4)
...
**Test:** `BISECT/crates/bisect-cli/src/bisection_runner.rs::test_leaf_sort_bfs_order` (verifies ["0","1","00","01"] not ["0","00","01","1"])
...
**Test:** `BISECT/crates/bisect-cli/src/bisection_runner.rs::test_invariant_target_weights_sum_to_one_2way` — verifies all BisectionTree nodes for k=2,3,4,7,8,14,52
...
`BISECT/crates/bisect-analysis/src/compactness.rs::test_perimeter_excludes_holes`
