...
\column{0.5\textwidth}
\includegraphics[width=\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/example_gerrymander.png}
\begin{center}
...
\column{0.5\textwidth}
\includegraphics[width=\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/tract_to_graph.png}
\end{columns}
\end{frame}
...
\begin{frame}{Visualizing Edge Weights}
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/edge_weights_example.png}
\end{figure}

\textbf{Key insight:} Thicker red edges are long boundaries (expensive to cut). Thin blue edges are short boundaries (cheap to cut).
\end{frame}

\begin{frame}{The Cut Operation}
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/graph_with_cut.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/before_after_cut.png}
\end{figure}
