...
\column{0.5\textwidth}
\includegraphics[width=\textwidth]{../../outputs/figures/schematic/example_gerrymander.png}
\begin{center}
\small{\textit{Example inspired by Illinois 4th District}}
\end{center}
\end{columns}
\end{frame}
...
\column{0.5\textwidth}
\includegraphics[width=\textwidth]{../../outputs/figures/schematic/tract_to_graph.png}
\end{columns}
\end{frame}
...
\begin{frame}{Real Geography: Minneapolis Census Tracts}
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{../../outputs/figures/real_tracts_examples/minneapolis_50_50_map_none_before_edgeweighted.png}
\end{figure}

\vspace{-0.5em}
\small
Twelve census tracts from the Minneapolis area. Notice the irregular shapes—this is real geography with streets, rivers, and neighborhood boundaries.

\vspace{0.5em}
\textbf{Goal:} Split these into 2 equal-population districts with compact boundaries.
\end{frame}

\begin{frame}{From Real Geography to Abstract Graph}
\begin{figure}
\centering
\includegraphics[width=0.98\textwidth]{../../outputs/figures/real_tracts_examples/minneapolis_50_50_both_none_before_edgeweighted.png}
\end{figure}

\vspace{-0.5em}
\small
\textbf{Left:} Actual census tracts from Minneapolis area with irregular shapes\\
\textbf{Right:} Same tracts as graph—nodes (circles), edges (lines)

\vspace{0.5em}
\textbf{Key insight:} The algorithm never "sees" geography, only the graph!
\end{frame}

\begin{frame}{Unweighted Partition: Why It Fails}
\begin{figure}
\centering
\includegraphics[width=0.98\textwidth]{../../outputs/figures/real_tracts_examples/minneapolis_50_50_both_cut_after_unweighted.png}
\end{figure}

\vspace{-0.5em}
\small
Traditional approach treats all edges equally. Result: Cuts 23.6 km of boundaries!

\vspace{0.5em}
\textbf{Problem:} Without edge weights, long boundaries look "cheap" to cut.
\end{frame}

\begin{frame}{Edge Weights: Show All Boundaries}
\begin{figure}
\centering
\includegraphics[width=0.98\textwidth]{../../outputs/figures/real_tracts_examples/minneapolis_50_50_both_all_before_edgeweighted.png}
\end{figure}

\vspace{-0.5em}
\small
Now we see all edge weights (boundary lengths in km). Longer boundaries should be more expensive to cut.
\end{frame}

\begin{frame}{Edge-Weighted Partition: Much Better!}
\begin{figure}
\centering
\includegraphics[width=0.98\textwidth]{../../outputs/figures/real_tracts_examples/minneapolis_50_50_both_all_after_edgeweighted.png}
\end{figure}

\vspace{-0.5em}
\small
With edge weights: Only 18.0 km cut—24\% less than unweighted! Higher compactness (PP: 0.445 vs 0.370).

\vspace{0.5em}
\textbf{Key result:} Edge weights guide METIS to find more compact districts.
\end{frame}

\begin{frame}{Works for Unequal Splits Too}
\begin{figure}
\centering
\includegraphics[width=0.98\textwidth]{../../outputs/figures/real_tracts_examples/minneapolis_67_33_both_all_after_edgeweighted.png}
\end{figure}

\vspace{-0.5em}
\small
Same 12 tracts, but split 2:1 (67-33) instead of 50-50. Edge weights still produce compact boundaries.

\vspace{0.5em}
\textbf{Flexibility:} Algorithm handles any population ratio.
\end{frame}

\begin{frame}{The Cut Operation (Schematic)}
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{../../outputs/figures/schematic/graph_with_cut.png}
\end{figure}

\textbf{What happened:} METIS cut 3 edges (red dashed lines) to create 2 balanced regions while minimizing total boundary length.
\end{frame}

\begin{frame}{Before and After Partitioning}
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{../../outputs/figures/schematic/before_after_cut.png}
\end{figure}

\textbf{Result:} Two balanced districts separated by cutting only the shortest boundaries.
\end{frame}

\begin{frame}[fragile]{How We Call METIS}
\textbf{METIS Graph File Format:}
\begin{verbatim}
6 7 011 2               % 6 vertices, 7 edges, format 011
2 5.2 1                 % Tract A: neighbor 2, weight 5.2
1 5.2 3 12.8 2          % Tract B: A (5.2km), C (12.8km)
2 12.8 3                % Tract C: B (12.8km)
...
\end{verbatim}
...
\vspace{0.5em}
\textbf{Output:} One partition ID per tract (0 or 1)
\begin{verbatim}
0  (Tract A -> District 0)
0  (Tract B -> District 0)
1  (Tract C -> District 1)
...
\end{verbatim}
\end{frame}
...
\includegraphics[width=\textwidth]{../../outputs/figures/round_progression/minnesota_round_1.png}
\begin{center}\small{Round 1: 2 regions}\end{center}

\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/figures/round_progression/minnesota_round_2.png}
\begin{center}\small{Round 2: 4 regions}\end{center}

\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/figures/round_progression/minnesota_round_3.png}
...
\begin{columns}
\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/figures/round_progression/alabama_round_1.png}
\begin{center}\small{Round 1: 2 regions\\(4 vs 3)}\end{center}

\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/figures/round_progression/alabama_round_2.png}
\begin{center}\small{Round 2: 4 regions}\end{center}

\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/figures/round_progression/alabama_round_3.png}
...
\begin{frame}{National Map: All 435 Districts}
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{../../outputs/presentations/edge_weighted_bisection/maps/us_all_districts.png}
\end{figure}

\vspace{-0.5em}
\small
Complete national map showing all algorithmically-generated districts for all 50 states based on 2020 Census. Alaska and Hawaii shown as insets.
\end{frame}
