"""
L2 tests for bisect_py.metis_graph_content and metis_parse_partition.
...
class TestMetisGraphContent:
    ...
    def test_header_no_edge_weights(self):
        content = bisect_py.metis_graph_content(LINEAR_ADJ, LINEAR_VW)
    ...
    def test_header_with_edge_weights(self):
        ew = {(0, 1): 150.0}
        content = bisect_py.metis_graph_content(LINEAR_ADJ, LINEAR_VW, edge_weights=ew)
        header = content.splitlines()[0]
    ...
    def test_empty_edge_weights_dict_treated_as_no_ew(self):
        content_none = bisect_py.metis_graph_content(LINEAR_ADJ, LINEAR_VW)
        content_empty = bisect_py.metis_graph_content(LINEAR_ADJ, LINEAR_VW, edge_weights={})
    ...
    def test_matches_python_implementation_no_ew(self):
        ...
        rs_content = bisect_py.metis_graph_content(LINEAR_ADJ, LINEAR_VW)
...
class TestMetisParsePartition:
    ...
    def test_parses_valid_partition(self):
        content = '0\n1\n0\n1\n'
        parts = bisect_py.metis_parse_partition(content, 4)
    ...
    def test_length_mismatch_raises(self):
        with pytest.raises(ValueError):
            bisect_py.metis_parse_partition('0\n1\n0\n', 4)
    ...
    def test_single_partition_valid(self):
        parts = bisect_py.metis_parse_partition('0\n', 1)
        assert parts == [0]
