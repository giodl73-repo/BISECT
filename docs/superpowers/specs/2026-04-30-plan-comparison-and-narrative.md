...
Template lives at `bisect-report/templates/comparison-narrative.j2.md` (or Typst equivalent). Customizable but ships with a default that reads like a press release.
