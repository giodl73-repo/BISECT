# NRS v0.3 VT 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 22,856 | 22,856 | 0 |
| County split units | 0 | 0 | +0 |
| Tract split units | 0 | 0 | +0 |

After maximum-overlap district-label matching, 22,856 of
22,856 blocks match (100.000000%); the
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/vt
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/vt
```
