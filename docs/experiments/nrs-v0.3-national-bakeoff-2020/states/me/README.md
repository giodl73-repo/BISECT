# NRS v0.3 ME 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 43,179 | 43,179 | 0 |
| County split units | 10 | 1 | -9 |
| Tract split units | 38 | 1 | -37 |

After maximum-overlap district-label matching, 32,880 of
43,179 blocks match (76.148128%); the
remaining 10,299 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/me
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/me
```
