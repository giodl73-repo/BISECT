# NRS v0.3 IL 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 363,324 | 363,324 | 0 |
| County split units | 59 | 32 | -27 |
| Tract split units | 746 | 528 | -218 |

After maximum-overlap district-label matching, 154,985 of
363,324 blocks match (42.657518%); the
remaining 208,339 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/il
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/il
```
