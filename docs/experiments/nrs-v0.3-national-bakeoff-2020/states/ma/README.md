# NRS v0.3 MA 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 102,527 | 102,527 | 0 |
| County split units | 12 | 9 | -3 |
| Tract split units | 371 | 58 | -313 |

After maximum-overlap district-label matching, 49,071 of
102,527 blocks match (47.861539%); the
remaining 53,456 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/ma
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/ma
```
