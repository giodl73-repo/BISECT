# NRS v0.3 OK 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 175,160 | 175,160 | 0 |
| County split units | 42 | 6 | -36 |
| Tract split units | 260 | 32 | -228 |

After maximum-overlap district-label matching, 86,170 of
175,160 blocks match (49.195022%); the
remaining 88,990 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/ok
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/ok
```
