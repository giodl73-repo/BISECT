# NRS v0.3 TN 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 176,552 | 176,552 | 0 |
| County split units | 73 | 10 | -63 |
| Tract split units | 441 | 101 | -340 |

After maximum-overlap district-label matching, 75,955 of
176,552 blocks match (43.021319%); the
remaining 100,597 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/tn
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/tn
```
