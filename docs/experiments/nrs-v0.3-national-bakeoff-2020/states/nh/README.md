# NRS v0.3 NH 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 30,498 | 30,498 | 0 |
| County split units | 5 | 5 | +0 |
| Tract split units | 48 | 3 | -45 |

After maximum-overlap district-label matching, 17,973 of
30,498 blocks match (58.931733%); the
remaining 12,525 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/nh
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/nh
```
