# NRS v0.3 CO 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 139,052 | 139,052 | 0 |
| County split units | 39 | 11 | -28 |
| Tract split units | 426 | 69 | -357 |

After maximum-overlap district-label matching, 52,673 of
139,052 blocks match (37.880074%); the
remaining 86,379 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/co
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/co
```
