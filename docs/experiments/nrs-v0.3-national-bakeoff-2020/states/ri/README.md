# NRS v0.3 RI 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 24,831 | 24,831 | 0 |
| County split units | 3 | 1 | -2 |
| Tract split units | 50 | 11 | -39 |

After maximum-overlap district-label matching, 17,365 of
24,831 blocks match (69.932745%); the
remaining 7,466 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/ri
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/ri
```
