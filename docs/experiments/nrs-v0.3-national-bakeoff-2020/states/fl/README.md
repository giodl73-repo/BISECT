# NRS v0.3 FL 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 375,513 | 375,513 | 0 |
| County split units | 57 | 17 | -40 |
| Tract split units | 1206 | 289 | -917 |

After maximum-overlap district-label matching, 180,385 of
375,513 blocks match (48.036952%); the
remaining 195,128 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/fl
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/fl
```
