# NRS v0.3 GA 2020 Tier 1 Bakeoff

**Status:** governed accepted evidence slice

| Measure | NRS v0.3 | Enacted CD118 comparator | Comparator minus NRS |
|---|---:|---:|---:|
| Blocks | 226,723 | 226,723 | 0 |
| County split units | 106 | 15 | -91 |
| Tract split units | 754 | 150 | -604 |

After maximum-overlap district-label matching, 101,570 of
226,723 blocks match (44.799160%); the
remaining 125,153 blocks are assigned to different
districts.
...
python scripts/research/analyze_nrs_bakeoff_slice.py --state RI --state-fips 44 `
  ...
  --output-dir docs/experiments/nrs-v0.3-national-bakeoff-2020/states/ga
python scripts/research/verify_nrs_bakeoff_slice.py docs/experiments/nrs-v0.3-national-bakeoff-2020/states/ga
```
