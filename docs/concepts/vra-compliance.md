...
- `BISECT/crates/bisect-core/src/vra.rs` — **single authoritative formula** (`build_vra_edge_weights`); both CLI and Python pipeline call this via PyO3
- `BISECT/crates/bisect-analysis/src/vra_analysis.rs` — `analyze_mm_districts()` (Rust)
