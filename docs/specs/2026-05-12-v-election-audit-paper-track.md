...
| V.10 | Certification Evidence Matrix | state-law survey, data availability, audit requirements | Separates what law requires from what RCOUNT can additionally prove. |
...
| V.10 | no crate required; legal/source matrix |
