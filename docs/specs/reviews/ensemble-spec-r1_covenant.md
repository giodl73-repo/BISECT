...
Without these additions, `bisect label-verify` cannot verify any run that uses the new modes, breaking the audit chain for any G-series paper that uses Short-Burst, Flip, or SMC.
