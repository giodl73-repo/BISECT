...
4. For litigation purposes, S.3 recommends a "litigation-grade" ensemble minimum: 20,000 steps for states with k≤17, 50,000 steps for states with k>17 (TX, CA, NY, FL). The bisect pipeline's U.10 implementation makes these run times feasible.
