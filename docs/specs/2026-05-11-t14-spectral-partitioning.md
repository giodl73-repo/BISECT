...
**Status:** Method-produced synthetic package generated
...
## Method-Produced Package

`docs/examples/rplan-method-packages/T.14+spectral-generated-synthetic/`
contains a deterministic six-unit path fixture generated by
`cargo run -p bisect-cli --no-default-features --example spectral_path6_package`.
It proves package generation, spectral lineage, manifest hashes, and verifier
acceptance for a synthetic construction fixture. It does not claim real-data
quality, benchmark performance, or legal sufficiency.
