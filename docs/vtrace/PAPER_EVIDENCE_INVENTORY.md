...
| G.0 | active RI/IA/NC tract package; completed replayed RI block gate; failed NH/NM/GA v1 and v2 expansions retained | V1 completed five primaries then stopped at GA Kruskal disk exhaustion with no governed replay. V2 stopped before its first preflight completed on compiled-runner identity drift. Cite v1 only for bounded feasibility/resource observations and both for their distinct negative gate results, not a completed multi-State ensemble claim. |
