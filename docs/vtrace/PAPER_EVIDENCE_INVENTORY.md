...
| G.0 | active RI/IA/NC tract package; completed replayed RI block gate; failed NH/NM/GA expansion retained | The expansion completed five primaries then stopped at GA Kruskal disk exhaustion with no governed replay. Cite it only for bounded feasibility/resource observations and the negative gate result, not a completed multi-State ensemble claim. |
