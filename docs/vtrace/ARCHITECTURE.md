...
| BISECT CLI and UI shells | PKG-010 | User-facing BISECT commands, TUI orchestration, and help behavior. Dashboard generation remains Python-owned until a concrete Rust replacement exists. Package-family CLIs remain owned by their package boundaries. | REQ-003, REQ-007, REQ-031, REQ-032 | IF-001, IF-006 | `crates/bisect-cli`, `crates/bisect-tui` | accepted |
