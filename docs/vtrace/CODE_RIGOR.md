...
| EVID-CR-018 | CR-011, CR-012, CR-013 | Public documentation pointers to VTRACE baseline. | bounded_discoverability_control | `README.md` and `docs/BISECT_CLI.md` now point maintainers to `docs/vtrace/INDEX.md`, state the `internal_engineering_baseline_only` posture, and route public/operator wording changes to `docs/vtrace/COMMUNICATIONS_STRATEGY.md`. The pointers improve discoverability without claiming public release, legal/court, external-user, or clean reproducibility readiness. |
...
| EVID-CR-021 | CR-011, CR-012, CR-013 | Artifact publication policy. | artifact_publication_policy_active | `docs/vtrace/ARTIFACT_PUBLICATION_POLICY.md` and Pulse 03 classify artifact commit/publication rules for source docs, research source, paper PDFs, generated figures, run outputs, dashboards, package evidence, public evidence packages, raw data, and local environment files. It promotes no generated artifacts and does not close DCR-004 L2. |
| EVID-CR-022 | CR-011, CR-012, CR-013 | Paper evidence inventory. | paper_evidence_inventory_active | `docs/vtrace/PAPER_EVIDENCE_INVENTORY.md` and Pulse 04 classify the `docs/PAPERS.md` paper index into evidence postures, track counts, declared gaps, and use rules. It does not recompute quantitative paper claims or assert external peer review. |
| EVID-CR-023 | CR-008, CR-009, CR-010, CR-013 | Package spec register. | package_spec_register_active | `docs/vtrace/PACKAGE_SPEC_REGISTER.md` and Pulse 05 route RPLAN, RCOUNT, RCTX, and RHIST schema/canonicalization control to package specs, crate constants, hash shapes, verifier paths, evidence posture, and change triggers. It does not restate schemas, create package versions, or promote package artifacts. |
| EVID-CR-024 | CR-011, CR-012, CR-013 | VTRACE baseline maintenance wave close. | complete_internal_control_wave | `context/waves/2026-06-01-vtrace-baseline-maintenance/CLOSE.md` closes Pulses 01-05 as an internal-control wave and preserves DCR/public/release/legal/external-user/clean-replay blockers. It does not upgrade S6 readiness. |
| EVID-CR-025 | CR-011, CR-012, CR-013 | Communications strategy. | bounded_communications_control | `docs/vtrace/COMMUNICATIONS_STRATEGY.md` maps audience, channel, message-class, blocked-language, claim-packet, review-lane, and stop-rule controls for public/operator communications. It does not publish a release, close DCRs, certify legal readiness, or upgrade S6 posture. |
