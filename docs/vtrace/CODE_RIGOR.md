...
| EVID-CR-014 | CR-011, CR-012, CR-013 | S5 integration control record. | in_progress_l1_control | `docs/vtrace/INTEGRATION.md` integrates S4 work-package evidence, DCR posture, validation classes, claim boundaries, custody gates, and blocked S6 claims. It is not release-readiness evidence until a specific S6 transition target is selected and its required L2 gates are satisfied. |
