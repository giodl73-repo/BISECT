...
| EVID-CR-013 | CR-006, CR-007, CR-011, CR-012, CR-013 | DCR-007 clean replay packet. | ready_for_clean_run | `docs/vtrace/REPRODUCIBILITY_RUN.md` now defines the L2 clean replay packet, declared replay fields, operator tasks, reviewer checklist, custody requirements, and promotion rule. It is not L2 replay evidence until MERIDIAN/COVENANT review accepts a clean replay record and VAULT dispositions any public artifact promotion. |
