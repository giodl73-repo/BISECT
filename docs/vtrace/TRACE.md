...
| DCR-003 | External-user walkthrough for non-author workflows. | REQ-032, REQ-034, REQ-035, SPEC-012, IF-001, IF-006, DES-013, WP-008 | Partial L1 via role simulation plus an L2 external-operator packet; L2 user-workflow review remains required before public-readiness claims. |
...
| DCR-007 | Full-scale or declared-subset reproducibility run. | REQ-007, REQ-008, REQ-009, REQ-012, SPEC-005, SPEC-NF-001, IF-001, IF-002, DES-013, WP-003 | Partial L1 release-subset candidate evidence via `REPRODUCIBILITY_RUN.md`; `scripts/maintenance/dcr007_release_subset_replay.py` captured a data-dirty VT candidate replay, but L2 clean replay review remains required before full-release or clean release-subset reproducibility claims. |
