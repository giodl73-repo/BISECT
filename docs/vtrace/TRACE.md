...
| DCR-004 | Stable public evidence package contract. | REQ-005, REQ-006, REQ-024, REQ-026, REQ-027, SPEC-004, SPEC-010, IF-006, DES-013, WP-005, WP-006 | Baseline L1 via `EVIDENCE_PACKAGE_CONTRACT.md`; L2 public artifact and custody review remain required before downstream contract claims. |
...
| DCR-006 | Court/legal packaging boundary. | REQ-010, REQ-011, REQ-026, SPEC-006, SPEC-010, IF-006, DES-013, WP-005, WP-006 | Baseline L1 via `COURT_PACKAGING_BOUNDARY.md`; L2 legal-boundary review remains required before court-ready or filing-ready language. |
...
| Release-readiness DCR coverage | partially executed | DCR-001 is closed at L2 and DCR-005 is closed at L1; DCR-002, DCR-003, DCR-004, DCR-006, and DCR-007 retain bounded partial/baseline evidence without release-health, external-user, legal filing, or full-scale reproducibility closure claims. |
