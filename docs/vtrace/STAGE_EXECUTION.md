...
| S6 | Readiness decision, transition notes, release/publication disposition | L1 internal baseline / L2 where applicable | Maintainers and external-user readiness lanes | `docs/vtrace/READINESS_DECISION.md` approves only an internal engineering baseline and blocks public release, legal/court, non-author, and clean reproducibility readiness claims. |
