...
| S5 Integration | in_progress_l1_control | integrated control record started; blocked for L2 release scope | Select an S6 transition target and attach the required external-user, clean replay, public-claim, and custody evidence for that target. |
