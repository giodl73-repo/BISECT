...
We do not ship a producer in `BISECT` itself — input format is decoupled from how you got the data. A reference Python producer is at `scripts/data/political/build_dem_shares.py` with two modes:
