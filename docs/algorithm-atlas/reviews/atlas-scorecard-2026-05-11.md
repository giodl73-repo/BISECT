...
| Band | Pages |
|---|---|
| Excellent, 54-60 | T.14, T.15, T.16, GeoSection, AreaSection, Seed Search, County-Sticky, ApportionRegions, Three-Layer Compositor, Multiscale, U.20 |
| Good, 45-53 | T.17, U.16, U.17, U.18, U.19, ReCom, SMC |
...
**T.17 - 46/60.** This construction page has good prose and ledgers, but its
main figure predates the stricter rubric. It needs a gold-standard teaching
figure: candidates, decision rule, and final artifact/status consequence.

## Upgrade Priority

1. **T.17**: upgrade the construction-family visual to show candidates,
...
T.14, T.15, T.16, GeoSection, AreaSection, County-Sticky, ApportionRegions, Three-Layer
