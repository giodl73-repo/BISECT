...
//! - bisect build commit + version + rustc
...
pub struct NarrativeManifest {
    ...
    /// `crates/bisect-report/templates/comparison-narrative.j2.md`).
...
/// - `build_commit_short` is the first 8 chars of `build_commit`
...
mod tests {
    ...
    fn fixture_inputs() -> NarrativeManifestInputs {
        ...
        NarrativeManifestInputs {
            template_path_rel: "crates/bisect-report/templates/comparison-narrative.j2.md".into(),
            ...
            build_commit: "deadbeef0123456789abcdef".into(),
    ...
    fn test_build_narrative_manifest_basic_shape() {
        ...
        assert_eq!(m.build_commit_short, "deadbeef");
    }
