...
\multirow{3}{*}{NC ($k=14$, $v_D=49.3\%$)}
  ...
  & ApportionRegions (T.4)$^\dagger$ & \textbf{7} & $\mathbf{+0.7}$ \\
  & ProportionalSection (T.5)$^\dagger$ & 5 & $-13.6$ \\
\midrule
\multirow{2}{*}{GA ($k=14$, $v_D=50.1\%$)}
  & Standard-bisect$^\dagger$ & 5 & $-14.4$ \\
  & ProportionalSection (T.5)$^\dagger$ & \textbf{6} & $\mathbf{-7.3}$ \\
\midrule
\multirow{2}{*}{MN ($k=8$, $v_D=53.5\%$)}
  & Standard-bisect$^\dagger$ & \textbf{4} & $\mathbf{-3.6}$ \\
  & ProportionalSection (T.5)$^\dagger$ & 3 & $-16.1$ \\
\midrule
\multirow{2}{*}{WI ($k=8$, $v_D=50.3\%$)}
  & Standard-bisect$^\dagger$ & 3 & $-12.8$ \\
  & ApportionRegions (T.4)$^\dagger$ & 2 & $-25.3$ \\
\bottomrule
\end{tabular}
\end{table}
...
(3) ProportionalSection (T.5) reduces the gap in GA ($-14.4$ to $-7.3$\,pp) but
