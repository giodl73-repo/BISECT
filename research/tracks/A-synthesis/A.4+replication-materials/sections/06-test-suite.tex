...
\subsection*{Quick Health Check: \texttt{bisect doctor}}

Before running any full-scale replication, confirm the environment is
correctly configured:

\begin{verbatim}
bisect doctor                        # General environment check
bisect doctor --check-tutorial-data  # Verify Vermont fixture data
\end{verbatim}
...
bisect state --state VT --year 2020 --version walkthrough

# Verify the output matches the fixture
bisect label-verify walkthrough
