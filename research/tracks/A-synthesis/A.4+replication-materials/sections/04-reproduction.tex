...
\noindent This installs Rust, builds the \texttt{bisect} binary, installs
Python dependencies, and runs \texttt{bisect doctor} to confirm the
environment is ready.  Expected time: 5--10 minutes.

\subsection*{Step 3 --- Fetch Census Data}

\begin{verbatim}
bisect fetch --year 2020      # ~40 GB, allow 30-90 min depending on connection
bisect fetch --year 2010
bisect fetch --year 2000
\end{verbatim}
...
\begin{verbatim}
bisect build official_2020 --year 2020    # All 50 states, ~18 min
bisect build official_2010 --year 2010
bisect build official_2000 --year 2000
\end{verbatim}
...
\begin{verbatim}
bisect label-verify official_2020    # Checks SHA chain for 2020 run
bisect label-verify official_2010
bisect label-verify official_2000
\end{verbatim}
