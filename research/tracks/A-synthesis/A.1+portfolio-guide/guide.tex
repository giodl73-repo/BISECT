...
correspond to the three-layer compositor of the \texttt{redist} binary:
...
\begin{itemize}[leftmargin=*,noitemsep,topsep=4pt]
    \item \textbf{Primary tool}: The \texttt{redist} Rust binary, built from
    ...
    \item \textbf{Census data}: U.S. Census Bureau redistricting files for
        2000, 2010, and 2020, downloaded via the \texttt{redist fetch} command.
