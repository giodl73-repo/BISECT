...
program comprises \textbf{120+ papers across twelve tracks (A--M)}, spanning
...
The portfolio is organized into twelve tracks. Track A synthesizes all other
...
\bottomrule
\caption{Portfolio track summary (120+ papers across twelve tracks A--M).}
\label{tab:tracks}
\end{longtable}
