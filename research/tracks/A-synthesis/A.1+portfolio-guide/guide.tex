...
program comprises \textbf{190+ papers across eighteen tracks (A--S)}, spanning
algorithm design and validation (Tracks B--C), legal compliance (Track D),
experimental extensions (Tracks E--F), ensemble-based plan evaluation
(Tracks G--H), incumbency and apportionment (Tracks I--J), compactness
and partisan fairness metrics (Tracks K--L), and community character weights
(Track M), with Track A providing cross-portfolio synthesis.
...
The portfolio is organized into eighteen tracks. Track A synthesizes all other
tracks; Tracks B--H generate the empirical, algorithmic, legal, and ensemble
results that the original synthesis draws on; Tracks I--M extend the program
to incumbency, apportionment, compactness, partisan fairness, and community
character weights; Tracks N--S extend to population counting, democratic outcomes,
reform pathways, 2030 planning, adversarial robustness, and statistical inference.
...
\textbf{A} & Portfolio Synthesis &
    120+ papers synthesized across 12 tracks; 50 states $\times$ 3 decades
...
\bottomrule
\caption{Portfolio track summary (190+ papers across eighteen tracks A--S).}
\label{tab:tracks}
\end{longtable}
