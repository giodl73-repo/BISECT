...
the frozen rule and ceremony genesis, release the root and later bisection
depths only after their review windows, receive public and expert evidence, adopt a
...
not predetermine the commission's legal judgment. A challenge can halt the
ceremony without erasing the already accepted prefix; correction of the
computational rule requires a new, explicitly linked ceremony.
