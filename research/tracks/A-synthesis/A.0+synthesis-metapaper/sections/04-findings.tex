...
and lower on Schwartzberg. A clean-detached-worktree replay from the separately
held certified context corpus regenerated all 150 State-cycle assignments,
matched their governed hashes, and passed the national Tier 1 and Tier 2
regeneration checks. The large corpus remains outside Git and must be supplied
through the documented data-transfer procedure. Because all four measures use
reconstructed common-block geometry, the result supports neither an original-
linework comparison nor a winner, fairness, intent, VRA, community, legal,
causal, robustness, or adoption claim. Elections, demographics, non-enacted
comparators, alternative BISECT structures, and converged block-level ensembles
