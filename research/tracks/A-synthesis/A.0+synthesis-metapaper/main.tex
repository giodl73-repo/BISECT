...
original-linework compactness or plan superiority. A newly implemented public
ceremony commits the rule before the root cut and releases certified cuts by
tree depth with fixed review windows and independently verifiable prefixes;
externally witnessed bakeoff evidence for that process remains pending. The contribution is therefore a reproducible operational baseline and
