...
\caption{\textbf{Minority-opportunity analysis template.} (A) Historical majority-minority threshold counts are opportunity diagnostics, not VRA compliance findings. (B) The 42\% value is exploratory, not a legal threshold. (C) The Pareto panel is a placeholder pending regenerated evidence.}
\label{fig:vra}
\end{figure*}

% NOTE: This is a placeholder template and is not used as completed evidence.
