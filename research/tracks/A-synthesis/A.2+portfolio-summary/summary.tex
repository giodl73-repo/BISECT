...
\large 75+ Papers Across 8 Research Tracks}
...
Congressional redistricting in the United States suffers a legitimacy crisis: partisan mapmakers manipulate district boundaries to predetermine election outcomes, eroding public confidence in representative democracy. This research program of 75+ papers across 8 research tracks demonstrates that \textbf{recursive graph bisection}---a computational method used for supercomputer workload distribution---provides an algorithmic alternative that \emph{cannot gerrymander because it cannot access partisan data}.
...
\textbf{Publication status}: This is an ongoing research program (75+ papers across 8 tracks). Track B foundations, several Track G ensemble papers, all Track H papers, and selected papers in Track B extensions are accepted or ready for submission. Remaining papers across all tracks are in draft. Preprints will be available on arXiv upon initial submission.

\textbf{For the entire research program}:

\begin{quote}
Della-Libera, G. (2026). Algorithmic redistricting: A 75+ paper research program across 8 tracks. Preprint series.
\end{quote}
...
\noindent\textbf{About this summary}: This 6-page research statement provides detailed descriptions of the foundation papers of the algorithmic redistricting portfolio (75+ papers across 8 research tracks). For a brief overview, see the 3-page \emph{Guide to the Algorithmic Redistricting Portfolio}. For full findings, see individual papers. For synthesis across papers, see Paper A.0 (Synthesis Metapaper for \emph{Science}).
