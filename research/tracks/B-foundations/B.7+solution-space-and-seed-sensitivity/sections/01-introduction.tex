...
The proposed Districting Integrity Act (DIA; see B.02~\citep{b02paper}) would specify a single deterministic
...
These results motivate the ConvergenceSweep procedure (U.1), which
