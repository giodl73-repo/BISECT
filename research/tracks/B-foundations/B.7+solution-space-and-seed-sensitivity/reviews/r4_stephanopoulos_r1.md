...
- **The T=600 ConvergenceSweep connection.** The last-improvement seed distribution data directly supports the U.1 threshold. The paper correctly presents this as providing the "statistical foundation" for T=600, though the formal connection needs strengthening (see P1.2).
