...
The empirical CDF language for the last-improvement seed section is appropriate. The section now correctly says "no parametric distributional model is fit" and "the empirical CDF is used by U.1 to calibrate the T=600 threshold." This is honest and does not overclaim.
