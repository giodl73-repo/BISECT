...
- **Report seed sensitivity for the alternative weight modes.** The limitations section acknowledges that county-sticky (T.3) and VRA-constrained (T.7) configurations may show different sensitivity profiles. Preliminary data on at least one alternative mode would strengthen the generalisability of the T=600 threshold across DIA configurations.
