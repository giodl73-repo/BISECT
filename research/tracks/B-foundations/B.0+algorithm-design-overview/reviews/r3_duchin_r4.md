...
The new paragraph acknowledges the conflation, provides the T.7 ablation result
...
> To isolate the alignment signal's causal contribution, T.7 includes an ablation
...
$2:5$, confirmed by T.7). I accept this as resolution of my P1.2 concern.
