...
outcome.
No such state exists in the competitive subset ($n=34$).
The 12.8\,pp range (GeoSection vs.\ ApportionRegions in Wisconsin) is
approximately $4\times$ the within-algorithm seed variance (CV $< 2\,\%$),
confirming that algorithm selection, not seed choice, drives partisan outcomes.
