...
the \emph{county-sticky weights} of T.3 control subdivision preservation;
the \emph{VRASection alignment score} of T.7 controls Gingles Prong~1 alignment;
the \emph{AreaSection dual constraint} of T.2 controls geographic fairness.
...
It synthesises findings from B.1 through T.8 into a unified framework.
...
the isoperimetrically normalised edge-cut introduced in GeoSection (T.1).
