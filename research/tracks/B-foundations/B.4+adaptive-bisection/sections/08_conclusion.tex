...
The 150 vs 68 MM districts finding from the companion 50-state study (B.5) \citep{dellaLibera2026nwayRecursive} demonstrates algorithmic redistricting dramatically improves minority representation. Critics argued sophisticated methods lack transparency. Our findings show this tradeoff is false:
...
\textbf{(4) Single census cycle}: Uses 2020 data only. Future work should analyze temporal stability (2010$ightarrow$2020$ightarrow$2030) 	o test whether method independence persists as demographics shift.
