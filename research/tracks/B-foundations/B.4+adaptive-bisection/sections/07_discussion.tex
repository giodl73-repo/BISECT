...
\textbf{(5) Temporal stability}: Test method equivalence across census cycles (2010$ightarrow$2020$ightarrow$2030). If edge-weighting produces deterministic results independent of method, results should remain stable over time as demographics shift.
...
\textbf{(7) Alternative VRA objectives}: Test influence districts (40-50\% minority) vs majority-minority districts ($geq$50\%). Edge-weighting may produce different convergence patterns at lower thresholds.
