...
\begin{figure}[h]
\centering
\IfFileExists{../../../../artifacts/papers/01_recursive_bisection/figures/political_margin_hist.png}{
\includegraphics[width=0.85\columnwidth]{../../../../artifacts/papers/01_recursive_bisection/figures/political_margin_hist.png}
}{
\fbox{\parbox{0.78\columnwidth}{\centering The historical political-margin histogram is not present in the current public artifact custody. The quantitative text remains a historical result and should be regenerated before publication reliance.}}
}
...
This creates an impossibility defense: partisan gerrymandering requires seeing partisan data; our algorithm never sees partisan data; therefore, our algorithm cannot be instructed to gerrymander. That means the process is insulated from partisan targeting, not that its outputs are partisan-neutral in every geography.
