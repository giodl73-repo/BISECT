...
\begin{enumerate}
\item \textbf{Has no access to partisan data} during optimization (Section~\ref{sec:parameter-sensitivity}),
...
\item \textbf{Legally relevant but not itself dispositive} under \textit{Rucho} (Section~\ref{sec:discussion}),
