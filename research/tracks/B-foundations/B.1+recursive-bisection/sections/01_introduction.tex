...
\textbf{The impossibility defense:} Traditional arguments against gerrymandering focus on intent—did mapmakers deliberately manipulate boundaries for partisan gain? This standard proves difficult to apply legally and institutionally, as \textit{Rucho} demonstrated. Our algorithm offers a stronger defense: \textit{impossibility}. The algorithm cannot be instructed to gerrymander because it cannot see partisan data. It draws boundaries based on population and adjacency alone. That is a procedural constraint, not a guarantee of partisan neutrality. Any partisan patterns in the results reflect the interaction between geographic voter distribution and compactness optimization, not strategic design.
