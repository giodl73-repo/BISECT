...
\textbf{Geographic sorting index: 0.64.} Prior simulation work finds a geography-driven Republican advantage in many Wisconsin plans \citep{chen2017impact}. The historical algorithmic result reported here is a 5--3 Republican split; a common-input regeneration is required before making a precise percentile claim.
