...
B.17~\citep{b17paper} answered the descriptive version of this question:
...
parameter range.
But B.17 did not frame the question adversarially.
...
\subsection{Relationship to B.17}

This paper uses B.17's 50-state dataset as its empirical foundation
but reorganises the analysis around the adversarial question.
B.17's primary finding---``parameter tuning produces $\leq 0.3$ seats of
