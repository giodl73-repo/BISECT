...
B.17's 50-state sweep~\citep{b17paper} provides the definitive empirical
answer.
...
The empirical combined effect from B.17's joint sweep: $\Delta D \leq 0.3$ seats.
...
following structural features of the algorithm (B.17, Section~5):
\begin{enumerate}
