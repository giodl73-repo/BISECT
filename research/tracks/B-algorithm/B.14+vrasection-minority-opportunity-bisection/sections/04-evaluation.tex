...
GeoSection selects a $3:4$ split for Alabama (the confirmed natural ratio from B.8 Table~1), producing a near-equal geographic division rather than isolating Birmingham.
...
GeoSection's $3:4$ as the confirmed natural ratio (B.8 Table~1)
