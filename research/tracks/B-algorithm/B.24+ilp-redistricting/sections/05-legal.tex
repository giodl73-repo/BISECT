...
in Phase~1, and their SHA hashes are not yet integrated into the B.17
parameter-sensitivity verification chain~\citep{b17paper}.
...
Until then, users requiring audit-chain integrity should manually record
the SHA256 of the MPS output file at time of generation and include
the hash in any expert report or disclosure.
