# B.16 ConvergenceSweep — R1 Panel Synthesis
...
1. **[Liang] ConvergenceSweep behavior with zero-seed-variance structures.** If --structure prime-factor (ApportionRegions) has zero seed variance (as established in B.11), ConvergenceSweep would terminate at T=1. Clarify whether a statutory AR+convergence run terminates immediately or runs the full 600 seeds, to avoid misleading users about sweep behavior.
