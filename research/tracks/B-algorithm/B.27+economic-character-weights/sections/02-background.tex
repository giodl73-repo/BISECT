...
B-track papers.
B.10 introduced subdivision-respecting (county) weights that strengthen
edges between tracts sharing the same county \citep{b10county}.
B.14 introduced VRA-aligned weights that strengthen edges between
minority-majority tracts to protect majority-minority districts \citep{b14vra}.
Economic character (B.27) introduces a third class of Layer~2 modification:
