...
Population equality is the primary constitutional requirement for congressional districts, established in \textit{Wesberry v. Sanders} (1964) and refined in \textit{Karcher v. Daggett} (1983), which requires populations "as nearly equal as practicable" \cite{wesberry1964,karcher1983}.
...
\noindent\textbf{Note on baseline comparisons.} The $-22.8\%$ gap above reflects the unweighted bisection baseline (this paper) compared to enacted maps. The companion paper B.2 reports a $+56\%$ figure using the unweighted bisection as its baseline (not enacted maps), and a separate $+20$--$22\%$ figure when comparing edge-weighted bisection to enacted maps. See Table~\ref{tab:compactness-headline} in A.0 Supplement for a full side-by-side comparison of all three baselines.
...
\includegraphics[width=\textwidth]{../../docs/figures/minnesota_round_1.png}
\caption{Round 1: $1 \to 2$ regions}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
\includegraphics[width=\textwidth]{../../docs/figures/minnesota_round_2.png}
\caption{Round 2: $2 \to 4$ regions}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
\includegraphics[width=\textwidth]{../../docs/figures/minnesota_round_3.png}
...
\centering
\begin{subfigure}[b]{0.32\textwidth}
\includegraphics[width=\textwidth]{../../docs/figures/alabama_round_1.png}
\caption{Round 1: $1 \to 2$ regions}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
\includegraphics[width=\textwidth]{../../docs/figures/alabama_round_2.png}
\caption{Round 2: $2 \to 4$ regions}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
\includegraphics[width=\textwidth]{../../docs/figures/alabama_round_3.png}
...
\input{sections/04_5_parameter_sensitivity}
