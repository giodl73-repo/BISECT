...
Algorithmic redistricting offers a stronger defense: \textit{impossibility}. The algorithm cannot be instructed to gerrymander because it cannot see the information required for gerrymandering. Partisan manipulation requires knowledge of voter behavior—which precincts lean Democratic, which neighborhoods vote Republican. Our algorithm possesses none of this knowledge. It draws boundaries based on population and adjacency alone. That is a procedural constraint, not a guarantee of partisan neutrality.
