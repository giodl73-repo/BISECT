...
\item \textbf{Enacted-plan dominance test.}
  ...
  simultaneously.
  If so, the selected-frontier package supports an argument that the legislature
  chose a plan that is simultaneously less compact, less proportional, and less
  VRA-compliant than an algorithmically discoverable alternative.
  This is record-based evidence of sub-optimal plan choice, not a standalone
  legal conclusion.
