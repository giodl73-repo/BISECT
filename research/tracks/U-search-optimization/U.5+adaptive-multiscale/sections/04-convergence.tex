...
These state-level traces remain empirical archive requirements.  The current
\texttt{U.5+adaptive-multiscale-smoke} package verifies only the deterministic
Robbins-Monro replay mechanics and seed contract, not the NC/TX/IA convergence
table.
