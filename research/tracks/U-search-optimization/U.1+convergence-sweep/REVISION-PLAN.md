# U.1 ConvergenceSweep — R1 Revision Plan
...
proportional-weights configuration established in T.5."
...
convergence, and the structure has zero seed variance (as established in T.4),
