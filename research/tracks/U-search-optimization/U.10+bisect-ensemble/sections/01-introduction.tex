...
within \texttt{bisect build} rather than as a separate overnight job.
...
The intended deployment is as the \texttt{bisect ensemble} subcommand,
integrated into the same binary as \texttt{bisect state},
\texttt{bisect analyze}, and \texttt{bisect map}.
