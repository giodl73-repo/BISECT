...
\re{} makes those results reproducible from the \texttt{bisect} Rust
...
The \texttt{bisect ensemble} subcommand should be integrated into
\texttt{bisect build} as an automatic post-redistricting audit step,
