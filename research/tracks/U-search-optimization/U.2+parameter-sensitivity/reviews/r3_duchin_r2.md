...
The U.1 citation issue is resolved in the references. The missing multiple-testing correction for the binomial tests is addressed: the paper now reports Holm-corrected p-values for all 20 non-baseline comparisons, and all are non-significant.
