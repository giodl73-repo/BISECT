...
This implements the ``county-respecting'' principle from T.3~\citep{b10paper}:
...
\begin{itemize}
\item $T = 100$: fast but may miss the global minimum (U.1 shows
...
In GeoSection/AreaSection (T.1/T.2), the area swing parameter controls
