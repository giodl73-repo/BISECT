...
This paper gives the empirical protocol needed to answer both questions through
a comprehensive 50-state parameter sweep.
The central claim to test is whether partisan seat counts are insensitive to
parameter tuning once the full parameter grid, output packages, and summary
...
\item \textbf{$T$ affects runtime, not outcomes.}
      ...
      This confirms U.1's finding that the algorithm converges well
      before $T = 600$.
\end{enumerate}
