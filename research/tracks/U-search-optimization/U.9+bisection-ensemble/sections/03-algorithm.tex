...
\begin{theorem}[Tractability]
  ...
  connected subgraph $H$ and balance tolerance $\varepsilon > 0$, the
  BisectionEnsemble chain accepts a balanced bisection within
  $O(\log(1/\delta))$ ReCom steps with probability at least $1 - \delta$.
\end{theorem}
