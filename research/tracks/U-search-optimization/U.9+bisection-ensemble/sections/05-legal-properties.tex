...
accepted feasible bisections of the local subregion. This provides a
node-local representativeness argument. It is not a claim that the final map is
drawn from, or representative of, the full-plan ReCom ensemble.
...
$\varepsilon$, falling back to the METIS initialisation if the finite local
chain accepts no proposals.
