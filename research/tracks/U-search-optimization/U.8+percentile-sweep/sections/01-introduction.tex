...
\footnote{The T=600 ConvergenceSweep formula is certified in U.1~\cite{b16paper} (Round~2, accepted; mean reviewer score 3.67/4). The formula's theoretical foundations and 89-seed empirical margin above Georgia's certified tail are documented in that paper.}
