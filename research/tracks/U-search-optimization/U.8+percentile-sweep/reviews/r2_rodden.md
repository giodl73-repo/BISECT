...
The revised §4.4 framing ("zero seats change for four of six states; TX and CA show at most 0.5 seats variation based on T.4 extrapolation") is significantly stronger than the original. The paper no longer implies that TX and CA are confirmed findings.
