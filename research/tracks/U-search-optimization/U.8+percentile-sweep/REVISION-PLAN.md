# REVISION PLAN — U.8 PercentileSweep (Round 2)
...
TX and CA now explicitly labeled as T.4 extrapolations, not confirmed PS sweeps. Four-state confirmed claim separated from two-state conjecture. R-P1-B and L-P1-C closed. TX/CA actual sweeps deferred to U.10.
...
| W10 | Add structural-bias challenge route + B.0/U.2 cross-ref to §5 | Stephanopoulos | S-P1-B |
...
| W16 | Add forward reference to U.10 for $T$-sensitivity check (GA/NC at $T = 601$) | Karypis, Liang |
...
- [ ] **K-P1-C**: $T = 601$ GA/NC sensitivity check — deferred to U.10 (forward reference needed).
...
- [ ] **S-P1-B**: Structural-bias challenge route not acknowledged; B.0/U.2 not cross-referenced in §5.
- [ ] **S-P1-C**: VRA posture omitted from taxonomy.

### From Liang

- [ ] **L-P1-A**: $T = 601$ sensitivity check not run (mitigated by scope narrowing; U.10 forward-ref needed).
