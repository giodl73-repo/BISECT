...
This table remains an empirical archive requirement.  The current
\texttt{U.11+resolution-smoke} package verifies resolution mapping mechanics
only; it is not a replay of the TX chains or their autocorrelation diagnostics.
...
The checked-in smoke fixture exercises the same prefix rule on a five-tract
synthetic graph, including orphan-detection-sensitive unit order and derived
coarse topology.
