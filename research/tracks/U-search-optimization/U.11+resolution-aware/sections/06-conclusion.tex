...
The \texttt{U.11+resolution-smoke} package now provides a replayable verifier
for that manifest/mapping claim.  The autocorrelation and legal-adequacy claims
remain package-bound future evidence.
...
All computations performed with the \bisect{} pipeline~\citep{dellaLibera2026b1}.

\paragraph{Code availability.}
The implementation is in \texttt{bisect-cli/src/adjacency\_loader.rs}
(\derive{}, \buildc{}) and \texttt{bisect-core/src/manifest.rs}
