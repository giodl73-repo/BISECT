...
\begin{enumerate}
  ...
  \item Disclose that \textsc{bisect} Reock is the centroid-radius approximation
    unless exact-MBC Reock was computed separately.
...
\begin{itemize}
  \item PP $\geq 0.18$, reported Reock $\geq 0.30$, CH $\geq 0.82$,
