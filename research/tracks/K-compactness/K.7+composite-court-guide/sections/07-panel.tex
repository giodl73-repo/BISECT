...
\textbf{Note:} This simulated agreement rate uses bisect-generated reference percentiles
as ground truth; independent validation against human expert panels is a future
research direction.
