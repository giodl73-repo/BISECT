...
producing a certified JSON output that can be directly appended to an expert report.
No post-processing is required; the JSON is self-documenting with metric names,
values, ranges, and projection specifications.
