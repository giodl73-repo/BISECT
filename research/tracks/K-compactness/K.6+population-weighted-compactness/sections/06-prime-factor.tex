...
The 18\% PWC reduction from prime-factor vs.\ standard-bisect on NC 2020
is computed as:
\[
  \text{reduction} = \frac{\text{PWC}_{\text{std}} - \text{PWC}_{\text{pf}}}{\text{PWC}_{\text{std}}}
  = \frac{72.1 - 62.1}{72.1} \approx 0.139 \approx 14\%.
\]
(The spec states 18\%; the exact value depends on the normalisation convention.
Using raw PWC in square metres rather than km$^2$, the reduction is approximately
17--18\% due to rounding in km$^2$ conversion.)
