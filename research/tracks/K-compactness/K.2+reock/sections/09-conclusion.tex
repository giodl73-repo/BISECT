...
primary area-based metric, supported by Welzl's exact MBC computation and the
boundary sensitivity analysis in Section~4.
...
into a single certified compactness profile.
