...
Key findings: (1) LW $> 3$ is a commonly used practitioner benchmark, appearing in
expert reports in Illinois and New York redistricting cases (K.5, Claim~1);
no federal court has established LW $> 3$ as a binding legal standard;
(2) all four bisect algorithms produce LW $\leq 2.8$ on NC 2020
