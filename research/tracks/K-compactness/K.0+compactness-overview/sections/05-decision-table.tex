...
Coastal/riverine state comparison &
  Reock &
  Less sensitive to TIGER/Line boundary artifacts than PP; MBC visually intuitive;
  used in NC (\textit{Harper v.\ Hall}) and WI (\textit{Gill v.\ Whitford}) &
  \texttt{--types reock} \\
\addlinespace
...
algorithm matters:
\begin{itemize}
  \item Maximise Reock: use \texttt{--structure moving-knife} (K.2).
