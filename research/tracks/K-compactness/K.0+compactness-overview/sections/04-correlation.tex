...
The moving-knife algorithm (MKA) produces higher reported Reock values
and lower LW values in these single-seed fixtures, consistent with its implemented
directional search over a worst-side compactness proxy (K.2).
