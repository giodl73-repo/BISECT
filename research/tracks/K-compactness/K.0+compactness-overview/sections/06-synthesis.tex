...
LW $> 3$ is a documented court threshold for elongation challenges (K.5, Claim~1);
...
Prime-factor reduces PWC 18\% below standard-bisect on NC 2020 due to hierarchical
...
a certified JSON appendix ready for court filing without post-processing (K.7, Claim~3).
