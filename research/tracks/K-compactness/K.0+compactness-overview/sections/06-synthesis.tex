...
Moving-knife achieves mean reported Reock $\geq 0.38$ on NC 2020 versus $0.31$ for
standard-bisect in the single-seed fixture (K.2).
The Reock--PP gap averages $+0.12$ under ratio-optimal across NC/WI/TX
(K.2), showing that the reported Reock proxy is more lenient than PP in those
rows.  K.2 now separates canonical exact-MBC Reock, the \textsc{bisect}
centroid-radius compactness report, and the moving-knife point-cloud proxy.
