...
multi-state comparison.  A fresh successor added actual-volume capacity
admission but closed before its first preflight completed because the bound
compiled runner rejected the successor execution identity; its validator also
retained the predecessor seed contract.  Any
further expansion therefore requires another fresh protocol and package plus a
compiled runner-contract test before process creation; it cannot continue
either failed schedule.
