...
framing.  The repository now contains an executable synthetic package showing
the artifact contract for G.1--G.3, and a separate missing-evidence package
identifying the real artifacts still needed for empirical percentile claims.
Accordingly, G.0's methodological claim is package-shaped: ensemble comparisons
are publication-ready only when trace, diagnostic, metric, election, RPLAN, and
RCTX artifacts are hash-bound and replayable.
