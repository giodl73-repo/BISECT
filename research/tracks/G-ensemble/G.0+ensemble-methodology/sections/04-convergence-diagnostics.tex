...
95\% interval estimates; G.4~\citep{g4paper} establishes 500 as the
...
The active synthetic G.1--G.3 package validates this artifact shape at small
scale.  The missing-evidence package remains the live ledger for real diagnostic
artifacts that must be added before G.1--G.3 percentiles can be cited as
completed external-ensemble findings.
