...
The \texttt{G.6-G.12+short-burst-smoke} package includes a concrete
\texttt{SBF\_CHAIN\_}/\texttt{SBF\_FWD\_}/\texttt{SBF\_REV\_} seed-stream
fixture for this rule.
...
\paragraph{Intended CLI invocation.}
\begin{verbatim}
bisect state --state NC --year 2020 \
    --search short-burst-forest \
    --burst-length 20 --n-bursts 50 --percentile 0.0
\end{verbatim}
This is the intended production surface; the current package verifies mechanics
only.
