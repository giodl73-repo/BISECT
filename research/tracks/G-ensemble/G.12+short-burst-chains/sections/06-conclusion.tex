...
All three variants have a common intended command shape:
\begin{verbatim}
...
\end{verbatim}
The current repository evidence is narrower: the
\texttt{G.6-G.12+short-burst-smoke} package verifies seed-stream,
endpoint-restart, selected-endpoint, and acceptance-rate mechanics.  Production
CLI commands and state empirical claims remain future package work.
