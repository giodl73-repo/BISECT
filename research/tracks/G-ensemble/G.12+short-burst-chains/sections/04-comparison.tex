...
\midrule
NC    & 14  & \textbf{430}$^\dagger$   & 442          & 437
      & 0.44                & 0.61 \\
WI    & 8   & \textbf{186}$^\dagger$   & 194          & 190
      & 0.42                & 0.59 \\
TX    & 38  & \textbf{1{,}820}$^\dagger$& 1{,}847     & 1{,}831
      & 0.47                & 0.63 \\
\bottomrule
\end{tabular}
\end{table}

\noindent$^\dagger$ Single-run result (seed=42); multi-seed variance to be reported in Phase~2.
...
Partisan outcomes (Democratic seat counts) are not reported for this paper; see G.6 for Short-Burst partisan analysis.
