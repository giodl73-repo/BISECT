...
\begin{enumerate}
  \item \textbf{Default pass}: All 50 states with
        \texttt{--structure prime-factor --weights-override county --search convergence}.
  ...
  \item \textbf{Large-$k$ pass}: TX, FL, CA, NY, PA, OH ($k \geq 15$) with
        \texttt{--structure simulated-annealing --search adaptive-multiscale --workers 16}.
  ...
  \item \textbf{VRA pass}: Jurisdictions with active Section~2 claims with
        \texttt{--structure ratio-optimal --weights-override vra-aligned --search vra-recom}.
