...
\texttt{bisect} ensemble platform --- Short-Burst, SMC, Flip, Forest ReCom,
...
The \texttt{bisect} platform implements six structure algorithms and twelve
...
\begin{enumerate}
  ...
  \item \textbf{Simulated Annealing} (\sa{}, U.3): METIS initialisation
  ...
  \item \textbf{CVD Graph-Distance} (\cvdg{}, T.10): Centroidal Voronoi
  ...
  \item \textbf{CVD Geographic} (\cvdgeo{}, T.11): CVD bisection using
  ...
  \item \textbf{BFS Growth} (\bfsgrow{}, T.12): Breadth-first search growth
  ...
  \item \textbf{ILP Exact} (\ilp{}, U.6): Integer linear program solving
...
\begin{enumerate}
  \item \textbf{ConvergenceSweep} (\cs{}, U.1): Multi-seed convergence
        sweep; federal statute default~\citep{dellaLibera2026convSweep}.
  \item \textbf{PercentileSweep} (\ps{}, U.8): Statutory choice of legal
        posture via percentile
        selection~\citep{dellaLibera2026percentileSweep}.
  \item \textbf{BisectionEnsemble} (\be{}, U.9): Local ReCom at bisection
  ...
  \item $\star$ \textbf{Parallel Tempering} (\pt{}, U.4): Replica exchange
  ...
  \item $\star$ \textbf{Adaptive Multi-scale} (\ams{}, U.5): Self-tuning
