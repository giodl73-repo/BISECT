...
Markov property.
The implementation in \texttt{bisect} as \texttt{--search short-burst}
...
\shb{} is appropriate for litigation support where a demonstrably
compact plan is required.
The 15--22\% PP improvement over single-seed METIS, achieved at
identical runtime cost, enables a straightforward argument: the submitted
plan was not merely drawn to pass a minimum compactness threshold but
was refined by neighbourhood exploration.
...
properties as B.11's \ar{} plan while achieving measurably higher
Polsby-Popper compactness.
The efficiency-gap neutrality ($|\mathrm{EG}| < 0.05$ across NC, WI, TX)
confirms that the compactness improvement is not purchased at the cost
of partisan skew---a requirement under the \dia{} framework.
