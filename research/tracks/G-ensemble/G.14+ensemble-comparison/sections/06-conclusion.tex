...
\texttt{--search} modes in the \texttt{bisect} CLI.
...
\begin{itemize}
  ...
  \item \texttt{--weights-override county}: county-respecting edge weights to
...
the three-layer compositor is a contribution of the \texttt{bisect}
platform itself.

\subsection{Future Work}

\paragraph{CVD and BFS Growth.}
Two geometric algorithms---CVD-based redistricting (T.10) and BFS Growth
(T.12)---are in development.
...
subject of U.5 (Adaptive Multi-scale) and is a natural extension for
