...
\footnote{The T=600 ConvergenceSweep formula is certified in B.16~\cite{deluca2026convergence} (Round~2, accepted; mean reviewer score 3.67/4). The formula's theoretical foundations and 89-seed empirical margin above Georgia's certified tail are documented in that paper.}
...
\begin{enumerate}[label=\textbf{Q\arabic*.}]
  ...
  \item \textbf{Is VRA compliance required?}
    ...
    initial plan.
    Use \texttt{--structure ratio-optimal-vra} (VRASection, B.14) to generate
    this plan first.
