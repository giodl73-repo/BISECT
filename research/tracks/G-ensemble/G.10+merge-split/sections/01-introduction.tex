...
partitions.
ForestRecom uses the two-tree UST approximation at $O(m \log m)$ per step---the same asymptotic cost as MergeSplit.
...
shares the same $O(m \log m)$ asymptotic cost via the two-tree UST approximation.
