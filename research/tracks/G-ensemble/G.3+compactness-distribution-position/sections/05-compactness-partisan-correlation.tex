...
\midrule
NC & $-0.18$ (95\% CI: $[-0.23, -0.13]$) & Higher PP $\to$ slightly fewer D seats \\
WI & $-0.09$ (95\% CI: $[-0.14, -0.04]$) & Weak (competitive) \\
GA & $-0.31$ (95\% CI: $[-0.36, -0.26]$) & Higher PP $\to$ fewer D seats \\
...
fewer Democratic seats.\footnote{Confidence intervals estimated via Fisher z-transformation; n varies by state.}  The effect is stronger in sorted states (Georgia)
