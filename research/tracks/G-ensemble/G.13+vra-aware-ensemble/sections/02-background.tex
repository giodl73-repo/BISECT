...
The Gingles bloc-voting analysis required to identify protected communities
satisfying the three-part Gingles test is described in~\cite{deluca2026gingles}
(companion paper D.5); the present paper takes the resulting district
identifiers as input without replicating that analysis.
% TODO: add bibtex entry for deluca2026gingles (D.5)
