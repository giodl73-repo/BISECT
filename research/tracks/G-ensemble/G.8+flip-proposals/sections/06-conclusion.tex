...
For context, we define ``adequate mixing'' in the ensemble setting (G.4, G.5)
as lag-100 Hamming autocorrelation $< 0.15$ and ESS $> 200$ per 1{,}000 steps;
the \flip{} chain does not satisfy these criteria and is not intended to.
