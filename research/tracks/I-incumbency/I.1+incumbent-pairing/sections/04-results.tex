...
(pairing count $C = 11$, rate $R = 11/78 = 0.141$, rounded to 0.143 in Table~\ref{tab:pairing-results}).
...
The pairing rate of 0.143 falls between the raw random baseline of 0.214 and the geographically adjusted
...
rounded to 0.125 in Table~\ref{tab:pairing-results}), arising from one district
