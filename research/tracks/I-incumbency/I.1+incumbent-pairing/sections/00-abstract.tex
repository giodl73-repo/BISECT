...
baseline. We find that \textsc{bisect} produces pairing rates of $0.141^\dagger$ (NC),
$0.107^\dagger$ (WI), and $0.105^\dagger$ (TX), all within one standard deviation of
the geographically adjusted random expectation. Enacted maps produce pairing rates of
0.000 (NC), 0.000 (WI), and 0.026 (TX)---below the random baseline in
all three states (preliminary single-seed $p < 0.05$ under a one-sided binomial test
assuming independent pairing events; exact permutation tests are a Phase~2 extension). We conclude that enacted
