...
pairing rates that are statistically inconsistent with random redistricting, implying
that mapmakers deliberately drew district boundaries to guarantee each sitting incumbent
a home district. The \textsc{bisect} algorithm, operating without incumbency data,
