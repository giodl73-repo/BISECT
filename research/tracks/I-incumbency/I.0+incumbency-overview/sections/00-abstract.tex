...
geographic constraints, and show that \textsc{bisect} outcomes fall within or
marginally above this baseline range on all three metrics across all three states
(the NC open-seat count of 4 slightly exceeds the $[0,3]$ 95\% CI as a consequence
of the pairing effect; all other metrics are within range). These are
5-seed validated observations across NC, WI, and TX; multi-seed SD is $< 0.03$ for
all three states (I.1 Table~2). Enacted 2022 congressional maps, by contrast, produce significantly lower
incumbent pairing rates and higher safe-seat fractions than the random incumbency-neutral
baseline in all three states, consistent with deliberate use of incumbent address data
that the \textsc{bisect} algorithm does not receive. The legal framework governing algorithmic treatment of incumbency is asymmetric:
