...
\midrule
NC ($k=14$) & Pairing rate & 0.143 & 0.000 & 0.222 \\
            & Safe-seat fraction & 0.43  & 0.64  & n/a \\
            & Open-seat count & 4     & 2     & 1.0--2.5 \\
\addlinespace
WI ($k=8$)  & Pairing rate & 0.125 & 0.000 & 0.175 \\
...
0.153. The \textsc{bisect} algorithmic maps produce pairing rates of 0.143 (NC),
0.125 (WI), and 0.105 (TX), all materially closer to the random baseline than to the
enacted map rates.
...
more modest but still present in Wisconsin (0.38 vs.\ 0.50). These differences are
statistically significant at conventional levels (I.2 reports $p < 0.01$ for NC and TX
under a two-sample test of proportions).
