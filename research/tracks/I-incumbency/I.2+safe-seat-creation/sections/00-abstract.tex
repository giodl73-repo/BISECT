...
below the enacted map fractions of 0.64 (NC), 0.50 (WI), and 0.71 (TX)
in all three states. These are preliminary single-seed observations ($^\dagger$);
multi-seed validation is required before interpreting as a general property of the algorithm.
Under a two-sample test of proportions using the single-seed bisect fractions, $p < 0.01$
for NC and TX, but these $p$-values should be treated as indicative, not definitive,
pending ensemble validation.
