...
WI ($k=8$)  & \textsc{bisect}$^\dagger$ & 2 & 1 & 2 & 2 & 1 & 0.38 \\
            & Enacted 2022              & 2 & 1 & 1 & 0 & 3 & 0.63 (rounded 0.50) \\
\addlinespace
TX ($k=38$) & \textsc{bisect}$^\dagger$ & 8 & 8 & 5 & 3 & 14 & 0.58 \\
            & Enacted 2022              & 7 & 5 & 2 & 5 & 19 & 0.68 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item[$\dagger$] Single-run result (seed\,$=42$). Safe-seat fraction reported as
  (Safe-D + Safe-R) / $k$. WI enacted fraction corrected: 4/8 = 0.50.
...
enacted NC safe-seat fraction is significantly higher than the \textsc{bisect} fraction
at the 1\% level.
...
4 safe seats (2 safe-D, 3 safe-R after the redistricting-adjusted count), for a fraction
...
map$^\dagger$ produces 22 safe seats (8 safe-D, 14 safe-R) for a fraction of 0.58.
The enacted TX map produces 26 safe seats (7 safe-D, 19 safe-R) for a fraction of 0.68.
...
TX difference is significant at the 5\% level.
