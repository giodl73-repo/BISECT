...
\textbf{California} (hold vs.\ $-1$), \textbf{Montana} ($-1$ vs.\ hold),
\textbf{Colorado} ($+1$ vs.\ hold), \textbf{Oregon} ($+1$ vs.\ hold),
\textbf{Minnesota} ($-1$ vs.\ hold), and \textbf{Rhode Island} ($-1$ vs.\ hold).
All six are within approximately 50{,}000 persons of the seat boundary under
