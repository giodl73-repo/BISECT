...
We estimate that approximately 180 census tracts nationally (90\% interval: 140--220)
would receive a different district assignment if student populations were reallocated
to home addresses for the 2020 redistricting cycle.
The interval reflects uncertainty in off-campus student enumeration (Census GQ type
700 captures on-campus housing; off-campus student renters are partially counted as
regular residents, so the true student-inflated count may be higher than GQ data alone).
