...
| M.8 | M.1 result (14.3 pp NC-14 proportionality gap) used as undaggered fact in §3 weight calibration | Add footnote: "This single-run result from M.1/M.9 is a dagger-qualified Phase 2 observation; if M.1 Phase 2 results differ, the 0.20 weight calibration remains justified by data quality and legal recognition arguments alone." |
