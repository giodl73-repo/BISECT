...
TIGER/Line \textbf{Special Districts} (the \texttt{SDSD} shapefile, not UNSD which
is the school district file) include fire protection districts and various water
and wastewater district types~\citep{census2020tiger}.
Download URL: \texttt{https://www2.census.gov/geo/tiger/TIGER\{year\}/SDSD/}
Note: UNSD = Unified School Districts; SDSD = Special Districts --- use SDSD for
fire and water districts, UNSD for school districts (Section~\ref{sec:school-data}).
