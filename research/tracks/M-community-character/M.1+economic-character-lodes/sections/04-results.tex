...
Formula and edge-weight mechanics are separately covered by the
\texttt{M.1+economic-character-smoke} evidence package; the state results below
remain single-run empirical outputs unless otherwise noted.
All experiments use:
\begin{itemize}
