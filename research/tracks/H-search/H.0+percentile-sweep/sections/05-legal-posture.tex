...
This bar is computed from the G.1 \gc{} ensemble (10,000 steps per state).
The percentile figures (0.1--0.7th percentile for most states) are point
estimates from a single ensemble run; their precision depends on G.1's
sample size and mixing time.
A more conservative statement is that the $p{=}0.0$ plan is more compact
than approximately 99\%+ of G.1 ensemble plans, with the exact percentile
subject to sampling uncertainty.
