...
partisan outcomes in any direction. Partisan outcomes are stable across
percentile levels $p$ for NC (zero seat change across all five $p$ values
in Table~\ref{tab:partisan}). Extension to GA and PA is deferred to Phase~2
empirical runs.
