...
\begin{verbatim}
# Replication: bisect state --state [XX] --partition-mode metis-vra --year 2020
import networkx as nx
...
def partition_with_metis(G, k, beta, tau):
    ...
    # Call METIS
    # See: redist analyze --label [plan] --types vra
    edgecut, parts = None, None  # replaced by redist Rust binary
...
# Install: cargo build --release --manifest-path redist/Cargo.toml
\end{verbatim}
