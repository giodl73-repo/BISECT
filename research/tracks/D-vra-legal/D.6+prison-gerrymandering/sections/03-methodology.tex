...
The current manuscript describes this as a proposed
\texttt{--adjust-prison-population} preprocessing mode rather than a shipped
CLI flag. This design keeps the adjustment entirely outside
...
# Apply prison population adjustment in the preprocessing workflow
...
The Hoke County example is a single-facility illustration; the full North
Carolina result in Section~\ref{sec:results} aggregates Hoke, Scotland, and
Davidson facilities and totals approximately 1,800 incarcerated people.
