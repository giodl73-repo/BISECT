...
\textbf{(2) Critical Threshold Discovery}: We identify a critical threshold around 42\% state-wide minority population (under multi-constraint optimization; edge-weighting reduces this to 36\%, see §3.2), above which VRA compliance is achievable with compact districts, below which it becomes infeasible without relaxing compactness.
