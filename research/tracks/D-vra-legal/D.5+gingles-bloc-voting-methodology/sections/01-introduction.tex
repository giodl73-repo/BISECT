...
three Gingles prongs using the \texttt{bisect} algorithmic redistricting
...
\begin{enumerate}
  ...
  \item A regression-based Prong 2 analysis using \texttt{bisect analyze
  ...
  \item An expert witness checklist mapping \texttt{bisect} outputs to each
...
the \texttt{bisect} system is Prong 1: the VRASection alignment score provides
