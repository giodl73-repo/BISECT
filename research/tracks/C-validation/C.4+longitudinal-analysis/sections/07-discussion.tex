...
\begin{enumerate}
    \item \textbf{Algorithmic stability}: Compactness remains consistent (0.41--0.44 PP)\footnote{Note: This paper uses the unweighted baseline configuration; the edge-weighted B.2 configuration produces PP $\approx$ 0.361. The temporal stability analysis (constant offset across years) holds for both configurations.} across dramatic population shifts
    \item \textbf{Enacted improvement}: Enacted district compactness improved 11\% (0.298$\to$0.331) as legislatures adapted to legal scrutiny, though still trailing algorithmic plans by 19--24\%
...
\subsubsection{Compactness Decline Over Time}
