...
\textbf{Assignment-Overlap Scope:} This paper analyzes only the 2010--2020
five-state tract relationship universe, so its reassignment and retention
claims rest on one decade. A separate governed NRS v0.3 package now compares
national recursive-node structure and normalized incumbent cuts for 2000,
2010, and 2020. That package does not compute cross-cycle assignment overlap:
adding 2000 to the present metrics still requires a defensible tract
relationship crosswalk or geometry overlay, and pre-2010 relationship data are
less systematic.
