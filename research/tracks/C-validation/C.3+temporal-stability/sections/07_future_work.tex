...
\textbf{Three-Cycle Assignment Study:} The governed NRS v0.3 evidence already
provides a 2000--2010--2020 national comparison of recursive topology and
normalized incumbent cuts. Extend the present work with a valid crosswalk or
geometry overlay so it can compare district assignments and resident
continuity across all three cycles. This would:
\begin{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Add 2000 Assignment Crosswalks:} Extend the tract-level
    assignment metrics to 2000--2010--2020 for Alabama and Georgia without
    inferring continuity from GEOID strings or recursive topology.
