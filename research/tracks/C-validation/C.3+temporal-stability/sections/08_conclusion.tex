...
Our analysis of five southern states over 2010-2020 reveals a fundamental finding: \textbf{hierarchical recursive bisection provides substantially greater temporal stability than flat n-way partitioning.} Recursive methods maintain 80\% tract retention versus 70\% for n-way (Cohen's $d=1.2$, $p=0.054$ two-tailed, $n=5$ states), reduce population disruption by 10 percentage points, and preserve 94\% of top-level geographic splits.
The $p$-value reflects the pilot-study scale; the large effect size ($d=1.2$) is the primary evidence of practical significance pending the planned 50-state replication. Communities of interest experience 14 percentage points less disruption.
...
The separate NRS v0.3 national package now extends structural comparison to
2000, 2010, and 2020, but it deliberately does not infer cross-cycle assignment
overlap. Future research should extend this paper's tract-level continuity
metrics with valid 2000 relationship or geometry data, expand the five-state
sample, and test hybrid or stability-aware methods. Enhanced
metrics—representative-constituent continuity, voter awareness surveys,
administrative cost models—would capture socio-political dimensions beyond
geographic stability. Integrating demographic projections could enable
proactive stability optimization, jointly planning 2020 and predicted 2030
boundaries.
