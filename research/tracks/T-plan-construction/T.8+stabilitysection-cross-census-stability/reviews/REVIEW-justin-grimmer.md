...
3. **The 2D stability matrix is a useful synthesis**: Combining seed stability (B.7) and census stability (T.8) into a 2x2 matrix is a good organizational framework. The prediction that the bottom-right cell (low seed stability, high census stability) should be empty is a testable cross-paper claim.
