...
initialisation.
T.8 establishes that it finds the same answer regardless of which decennial
...
StabilitySection is implemented in the \texttt{bisect} Rust binary.
Cross-census GeoSection runs use \texttt{bisect state --year \{2000,2010,2020\}
