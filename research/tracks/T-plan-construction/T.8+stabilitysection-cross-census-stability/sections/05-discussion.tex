...
\begin{conjecture}[CSS as Geographic Burden Shift]
...
different partition across three independent census cycles.\footnote{This
conjecture is supported empirically across all 50 states for three census
decades (2000, 2010, 2020). A formal mathematical proof under the stated
regularity conditions is left as an open problem.}
\end{conjecture}
...
discrepancy could not be attributed to any geographic force: the algorithm,
across three censuses, has consistently identified Milwaukee's compact
geography as the natural first-level peel.
...
This framing establishes that the 67\,\% finding is not an artefact of a
...
Combining B.7's seed stability results with T.8's census stability predictions,
we can sketch a $2\times 2$ stability matrix:

\begin{table}[h]
\centering
\caption{$2\times 2$ stability matrix: seed stability (B.7) $\times$ census
  stability (T.8 predicted). Representative states in each cell.}
