...
plt.tight_layout()
fig.savefig('research/T.2+areasection-dual-population-area-constraint/figures/lorenz_wi.pdf',
            bbox_inches='tight')
fig.savefig('research/T.2+areasection-dual-population-area-constraint/figures/lorenz_wi.png',
