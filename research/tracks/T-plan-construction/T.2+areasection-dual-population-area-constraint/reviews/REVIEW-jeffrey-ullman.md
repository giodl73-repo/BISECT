...
The isoperimetric normalization EC/sqrt(min(i, k-i)) is inherited from T.1 (GeoSection) and justified by analogy to the isoperimetric inequality. This is not a proof. The paper should either cite a theorem or label this explicitly as an empirically-motivated heuristic.
