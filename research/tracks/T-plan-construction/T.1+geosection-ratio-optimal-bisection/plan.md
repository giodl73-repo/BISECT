...
**Companion**: T.2 — AreaSection (dual population+area constraints, separate paper)
...
**AreaSection is a separate paper (T.2).** Dual population+area constraints
...
## Companion Paper: T.2 AreaSection
...
5. Write up T.2 AreaSection as separate paper
