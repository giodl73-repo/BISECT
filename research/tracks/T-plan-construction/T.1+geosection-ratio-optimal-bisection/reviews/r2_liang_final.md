...
**Reproducibility.** The paper should report the commit hash of the redist binary used to produce all results, as Ce Zhang recommended for T.2. One sentence in §4.1 is sufficient. This allows external auditors to verify the implementation exactly.
