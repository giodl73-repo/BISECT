...
Of 44 comparable states, 37 produce identical seat counts under GeoSection
...
ratio structure does not change the number of Democratic seats in 84\,\%
of states.
...
GeoSection is implemented in the open-source \texttt{bisect} Rust binary
(\texttt{bisect state --partition-mode geosection}).
