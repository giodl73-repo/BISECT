...
Simulated Annealing (U.3) requires an initial temperature factor and
step count per tract~\citep{b19paper}.
CVD (T.10) requires an iteration count~\citep{b22paper}.
\cs{} (U.1) requires a convergence threshold $T$~\citep{b16paper}.
...
higher PP than \metis{} (by 9--14\%) because geographic proximity packing naturally
...
substantially faster than SA (U.3) or CVD (T.10).
