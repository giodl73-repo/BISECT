...
**4. Why does NC worsen at all η?** The paper explains that the T.5 constraint forces 7:7 D-bloc split but the D-bloc "has insufficient Democratic concentration to win all 7 districts." This explanation needs one additional step: specifically, what is the Democratic concentration in the NC D-bloc under T.5 at η=1.10? If it is, say, 52%, then the issue is that the D-bloc geography is insufficiently cohesive, which is a specific measurable claim. Providing this concentration value would make the NC explanation much sharper.
