...
2. **Nevada explanation is mechanistically satisfying.** Low-k granularity as the mechanism is specific and testable. The general principle (small k states are less reliable for T.5) is a useful take-away.

3. **"Scope of Claims" subsection makes the paper more honest.** Item (3) — the algorithm is explicitly partisan — is the most important disclaimer. Researchers and practitioners need to understand that T.5 is not a neutral algorithm.
