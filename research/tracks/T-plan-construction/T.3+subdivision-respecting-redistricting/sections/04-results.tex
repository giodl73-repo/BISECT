...
\subsection[National summary at alpha-c = 3.0]{National summary at $\alpha_c = 3.0$}
...
\subsection[alpha-c sweep by state category]{$\alpha_c$ sweep by state category}
...
\subsection[Case study: Iowa]{Case study: Iowa ($k{=}4$, 99 counties)}
...
\subsection[Case study: Texas]{Case study: Texas ($k{=}38$, 254 counties)}
...
\subsection[Case study: California]{Case study: California ($k{=}52$, 58 counties)}
