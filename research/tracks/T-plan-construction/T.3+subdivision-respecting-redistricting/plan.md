# T.3 — Subdivision-Respecting Redistricting: Governmental Hierarchy as Edge-Weight Signal
...
T.3 — extends B.2 (edge-weighted bisection) to use governmental hierarchy as the
