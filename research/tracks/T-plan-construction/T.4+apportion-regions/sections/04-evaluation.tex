...
canonical AR factorization (largest prime first). Seven seat counts are prime and
...
\caption{AR partisan outcomes across 10--20 seeds. Variance = number of seeds
  ...
  AR produces identical partitions regardless of METIS seed.}
...
If AR's output is independent of the METIS seed, the map is determined by
...
This strengthens the constitutional claim: AR is not merely reproducible given
