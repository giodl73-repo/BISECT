...
\sa{} (U.3)     & Edge cut (graph) + SA  & Seeded  & None         & Done \\
\geosec{} (T.1)  & Direction + EC ratio   & Seeded  & None         & Done \\
\areasec{} (T.2) & Area-swing + EC        & Seeded  & None         & Done \\
\textbf{\cvd{} (T.10)} & \textbf{Geographic distance} & \textbf{Seeded}
                        & \textbf{None (P1) / Centroids (P2)} & \textbf{This paper} \\
\bfsgrowth{} (T.12) & Population balance + proximity & Seeded & None & T.12 \\
\bottomrule
\end{tabular}
\end{table}
