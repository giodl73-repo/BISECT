...
\bottomrule
\end{tabular}
\caption{Partisan outcomes (2020 presidential, single run, seed $s=42$).
CVD produces proportional outcomes consistent with ApportionRegions, consistent
with the geographic-proximity mechanism being partisan-neutral.
\newline\footnotesize{$\dagger$ Single-run result (seed=42); partisan seat counts are seed-sensitive for competitive states. Multi-seed validation (50 runs) deferred to Phase~2.}}
\label{tab:partisan}
\end{table}
...
confirming that CVD plans occupy a geometrically distinct region of plan space.
