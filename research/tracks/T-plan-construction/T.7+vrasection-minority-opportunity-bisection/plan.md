# T.7 — VRASection: Minority Opportunity Districts via Geographic Concentration Bisection

**Paper Type**: Algorithm Design + Legal Analysis + Empirical Comparison  
**Status**: Planning (2026-05-02)  
**Series**: B (Algorithm Design)  
**Depends on**: B.3 (multi-constraint VRA failure analysis), T.1 (GeoSection — ratio scanning infrastructure)  
...
- **T.1 (GeoSection)**: VRASection is a wrapper around GeoSection's ratio
