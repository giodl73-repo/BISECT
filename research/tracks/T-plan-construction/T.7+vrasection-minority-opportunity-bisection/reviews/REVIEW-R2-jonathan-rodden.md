...
at 1:13 is the canonical caterpillar move that GeoSection's T.1 isoperimetric
...
3. The partisan geometry note (more peeling → caterpillar reintroduction) deserves
   ...
   over the T.1 anti-caterpillar objective when a Section 2 obligation exists?
