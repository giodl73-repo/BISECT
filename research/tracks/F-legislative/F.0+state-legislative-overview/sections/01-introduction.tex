...
\texttt{bisect} pipeline---the minimum-edge-cut recursive bisection algorithm
...
introduces the \texttt{bisect} CLI extensions for state legislative redistricting.
