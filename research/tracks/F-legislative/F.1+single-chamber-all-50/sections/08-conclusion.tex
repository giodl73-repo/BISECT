...
First, the \texttt{bisect} pipeline scales gracefully to the state legislative
...
can generate one using \texttt{bisect state --chamber house --resolution block\_group}
