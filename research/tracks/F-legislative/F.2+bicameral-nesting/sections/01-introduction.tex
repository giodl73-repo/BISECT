...
Under California's pre-2008 constitutional structure, senate districts were required
to consist of two complete, contiguous assembly districts.
Since Proposition~11 (2008), the Citizens Redistricting Commission (CRC) draws
senate and assembly districts independently; nesting is not constitutionally required.
...
Companion paper T.6 \citep{dellaLibera2026nestSection} introduced the
...
\begin{enumerate}
  ...
  \item Application of NestSection to all 40 compatible states, producing
  ...
  \item A classification of the 9 incompatible states ($\gcd = 1$) and
...
Section~\ref{sec:results} reports NestSection results for the 40 compatible states.
