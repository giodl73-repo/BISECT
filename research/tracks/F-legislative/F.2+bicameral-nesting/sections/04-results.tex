...
NestSection successfully produces nested bicameral maps for all 40 compatible
...
In practice, all 40 compatible states succeed because METIS's balance tolerance
...
In all 40 compatible states, senate districts have lower mean PP than house
...
(senate PP = house PP $- 0.028$ on average across the 40 compatible states).
