...
\caption{NestSection compatibility for all 49 bicameral states.
  ...
  40 states are compatible; 9 are not (Missouri, Oklahoma, Texas, Hawaii,
...
\begin{itemize}
  \item \textbf{40 compatible} ($g > 1$): NestSection produces a valid
  ...
  \item \textbf{9 incompatible} ($g = 1$): House and senate district counts
...
The nine incompatible states are geographically and politically heterogeneous:
