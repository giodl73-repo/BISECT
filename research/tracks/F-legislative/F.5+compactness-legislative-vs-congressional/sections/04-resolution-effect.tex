...
Across all 50 states and three census years (2000/2010/2020), the mean PP improvement from tract to block group resolution is 0.013 PP units (three-year average across 2000/2010/2020 census cycles; 3.4\% improvement relative to tract-resolution PP). For the 2020 census year alone the effect is somewhat larger (approximately 0.020 PP units (2020 census year only)), because 2020 block group boundaries are more precisely aligned with current geographic features. Table~\ref{tab:main_results} (column 4) reports the block group PP for each state.
...
The two effects---scale and resolution---combine multiplicatively. State house maps at block group resolution combine the benefits of many small districts (the $O(1/\sqrt{k})$ scaling advantage) with the benefits of precise boundary tracing (the $+0.013$ resolution effect (three-year average across 2000/2010/2020 census cycles)). The result is the headline finding: state house PP at block group resolution (mean 0.401) versus congressional PP at tract resolution (mean 0.361), a difference of 0.040 PP units (11\%).
