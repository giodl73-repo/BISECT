We apply the same edge-weighted recursive bisection algorithm used throughout this paper series \citep{dellib2026edgeweighted} to each country's geographic units and population data. The implementation uses the \texttt{bisect} platform version 0.1.0 \citep{redistcli2026} with country-specific adaptations described below.
