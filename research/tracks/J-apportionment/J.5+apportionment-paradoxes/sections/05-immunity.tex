...
The \textsc{bisect-apportion} crate verifies paradox immunity for HH
empirically:
\begin{itemize}
  \item \textbf{Alabama paradox check}: For $H \in \{434, 435, 436\}$
    and 2020 Census data, no state's seat count decreases as $H$ increases.
    The L0 test asserts this invariant.
  \item \textbf{Population paradox check}: Increasing any state's
    population by 1 in the 2020 data does not decrease that state's
    seat count.
    The L0 test asserts monotone non-decrease for each state.
\end{itemize}
