...
\textsc{bisect-apportion}'s implementation of all five methods enables
...
issues.
The SHA-verified correctness of \textsc{bisect-apportion} is thus
legally as well as mathematically significant: it establishes an
auditable chain of custody from the Census Bureau's published
population figures to the final seat counts.
