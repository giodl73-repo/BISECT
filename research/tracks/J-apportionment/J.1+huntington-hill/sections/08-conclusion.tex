...
The current \textsc{bisect-apportion} implementation provides practitioners
with an auditable Huntington-Hill library path.  Exact official-output
verification for 2020, 2010, and 2000 Census data, integer priority-comparison
hardening, and a standalone CLI remain future implementation work.
...
Practitioners using \textsc{bisect} for redistricting should treat
\textsc{bisect-apportion} as the current library substrate for the statutory
method, with Census-reference fixtures still needed for courtroom-grade audit
claims.
