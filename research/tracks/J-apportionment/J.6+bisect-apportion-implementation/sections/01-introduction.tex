...
\begin{enumerate}
  \item \textbf{Double-precision arithmetic}: Priority values are compared
    as \texttt{f64} floating-point, which provides exact results for the
    integer-valued populations and seat counts used in apportionment.
  \item \textbf{Output verification}: The crate's L2 tests compare its
    ...
    SHA-256 cryptographic verification is planned for Phase~2.
