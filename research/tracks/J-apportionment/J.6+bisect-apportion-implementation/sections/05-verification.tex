...
SHA-256 seed verification remains a planned hardening step; currently the
implementation uses the deterministic seed formula
$s_0 = f(\text{census\_release\_id})$ without cryptographic verification.
