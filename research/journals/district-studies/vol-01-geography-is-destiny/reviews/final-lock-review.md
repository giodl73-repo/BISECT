...
status: final-lock-review
updated: 2026-05-09
review-target: PROVISIONAL-PACKET.md
decision: hold at provisional
---
...
Do not move District Studies Vol. 1 to `locked` yet.

Approve it as a **provisional public preview**: coherent enough to show as a
staged research issue, but not final publication.

## Why Not Locked

The scope-down issue is safe, readable, and useful, but a locked issue should
...
Those blockers are acceptable for a provisional public preview because the
issue does not rely on them. They still prevent a final lock.

## Board Result

| Role | Finding | Result |
|------|---------|--------|
| BOUNDARY | No legal or adoption claim should block public preview. Do not call it final. | preview pass |
| SCALE | The quantitative claims are bounded. Keep all exact-value language out. | preview pass |
...
Use this label if showing the issue:

> Provisional public preview. This issue is a staged diagnostic draft, not a
> locked publication.
