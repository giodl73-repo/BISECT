...
|-----|--------|----------|--------------------|
| [B12] | `research/tracks/T-plan-construction/T.5+proportional-section/` | Geography/proportionality mechanism; qualitative state-type frame | Use qualitatively only; exact table values and paper-run parameters remain gated |
...
| [B11] | `research/tracks/T-plan-construction/T.4+apportion-regions/` | Deferred support for NC/TX and ApportionRegions context | Not a headline Vol. 1 source |
...
| Gate | Source | Effect |
|------|--------|--------|
| T.5 source-chain audit | `reviews/b12-reproducibility-and-scope-audit.md` | Blocks exact T.5 table values |
| T.5 implementation provenance | `reviews/b12-implementation-provenance-note.md` | Blocks inference from current defaults to paper-run parameters |
