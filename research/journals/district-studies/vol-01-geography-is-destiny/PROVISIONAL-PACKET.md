...
# Provisional Packet: Geography Is Destiny

This packet is the current human-review front door for District Studies Vol. 1.
The issue is in **provisional public preview**, not locked publication.
...
voters live. This issue tests that geography-first explanation before moving to
...
The provisional drafts passed BOUNDARY/SCALE/DATUM review for the approved
scope-down strategy. They still need final lock review before public release.

See [Provisional Draft Review](reviews/provisional-draft-review.md).

See [References](REFERENCES.md) for the provisional source layer.
...
| Reference layer | complete | Provisional source file added; final citation format still open |
| Final lock review | complete | Held at provisional public preview |

## Next Move

Use this packet for public preview or board review. Do not mark Vol. 1 `locked`
until the requirements in `reviews/final-lock-review.md` are complete.
