...
This is the provisional public index for District Studies Vol. 1. The issue is
in **provisional public preview**, not locked publication.
...
- L.1/C.5 result-bearing measurement claims are deferred until output provenance
  is regenerated or traced to post-fix artifacts.
...
- [Scope-down decision](decisions/scope-down-path.md)
- [Editor approval](decisions/editor-approval-scope-down.md)
- [Preview decision](decisions/preview-not-locked.md)
