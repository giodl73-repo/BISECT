...
arc-position: 1 of 10 — opens the empirical program
reader-promise: "Partisan outcomes in American redistricting are strongly constrained by where voters live. This issue tests how much geography explains before moving to reform claims."
target-reader: Political journalists, policy researchers, informed citizens who think gerrymandering is about clever map-drawing
excluded-claims: No claims about what to do about it (that's The Districting Review). No algorithm advocacy. Pure diagnosis.
terminal-connection: If geography explains a large share of outcomes, a geographic algorithmic baseline becomes a candidate standard worth evaluating.
---

> Audition status: this brief defines the issue thesis and candidate papers. It does not yet publish the thesis as a reviewed claim.

## Reader Promise (expanded)

The conventional narrative says gerrymandering is about politicians drawing sneaky shapes. The research corpus asks how much of the observed partisan outcome follows from the physical distribution of voters across space. Democrats often pack into cities; Republicans are more spread across suburbs and rural areas. This volume tests the claim that compact geographic districts can produce partisan asymmetry without intentional manipulation.
...
- Any mention of the algorithm being "better" — this volume is descriptive, not prescriptive
