...
| TDR1-009 | Build one-file audition packet for human review | DATUM/COMMONS | complete |
| TDR1-010 | Expand approved summaries into provisional preview drafts | COMMONS/DATUM | complete |
| TDR1-011 | Final risky-claim scan before preview | BOUNDARY/SCALE | complete; accepted hits are guardrails |
| TDR1-012 | Human editor approval of qualitative preview path | BOUNDARY/DATUM/COMMONS | complete; provisional preview approved |
| TDR1-013 | Package Vol. 1 as provisional public preview if approved | DATUM/COMMONS | complete |
| TDR1-014 | Final publication packaging if lock is later requested | DATUM/COMMONS | open |
