...
- [B17] may support bounded variation, but not universal neutrality.
- [R1] may support pre-registration and parameter binding, but not impossibility language.
- [A4] may support reproducibility claims, but not legal-admissibility claims.
- [H0] may support court-facing language, but should remain descriptive.
